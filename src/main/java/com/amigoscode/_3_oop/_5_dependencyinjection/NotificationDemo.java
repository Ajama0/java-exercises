...
class NotificationDemo {
    public static void main(String[] args) {
        ...
        notificationService.sendMessage("abas@example.com", "Hello from email");


        NotificationService sms = new NotificationService(new SmsSender());
        sms.sendMessage("abas@example.com", "Hello froms sms");
        ...
        NotificationService temp = new NotificationService(sender);
        temp.sendMessage("abas@example.com", "Hello from email temp");


        sender = new SmsSender();
        sender.send("abas@example.com", "Hello froms sms sender");
    }
}
