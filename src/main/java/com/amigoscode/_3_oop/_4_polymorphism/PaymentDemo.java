...
class PaymentDemo {
    public static void main(String[] args) {
        ...
        payments.add(new BankTransferPayment("Bank112D"));
        payments.add(new CreditCardPayment("49218821388288182"));
        payments.add(new PayPalPayment("Abas@example.com"));

        PaymentProcessor paymentProcessor = new PaymentProcessor();
        paymentProcessor.processAllPayments(payments, 1000.00);
        ...
        Payment p = new BankTransferPayment("Bank112D");
